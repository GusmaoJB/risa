...
#' `transform_to_metric()`
#'
#' @importFrom terra crs project trim ext xmin xmax ymin ymax is.int is.factor is.lonlat ifel
#' @importFrom sf st_as_sf st_as_sfc st_bbox st_crs st_is_longlat st_transform
#'
#' @export
